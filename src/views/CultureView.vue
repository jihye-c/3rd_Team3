  ...
  <div class="w-full">
    ...
    <div class="max-w-[1600px] mx-auto">
      ...
      <div class="flex justify-center gap-8 mt-10">
        <div class="w-[652px] h-[380px]">
          <CalendarComponent />
        </div>
    
        <div class="w-[832px] h-[380px] bg-mono-100 p-6">
      ...
      <div class="flex justify-center gap-8 mt-10">
        ...
        <div class="flex flex-col items-center w-[1200px]">
          ...
          <div class="grid grid-cols-3 gap-4 w-full mt-10">
            <div v-for="n in 9" :key="n" class="bg-mono-100 p-4 rounded-lg shadow">
              <p class="text-sm text-mono-600 flex items-center">
                <span class="w-2 h-2 bg-main-400 rounded-full mr-2"></span>{{ banners[n % banners.length].location }}
              </p>
              <img :src="banners[n % banners.length].image" class="h-[340px] w-full object-cover rounded-lg" />
              <p class="mt-2 font-bold text-mono-900">{{ banners[n % banners.length].title }}</p>
